...
class A10Endpoint(object):
    ...
    def create_load_balancer(self, context, msg):
        LOG.info('A10 Endpoint Creating load balancer \'%s\'...', msg)
        self.worker.create_load_balancer(msg)
