...
class GetNetworkFromVIP(BaseNetworkTask):

    def execute(self, loadbalancer):
        LOG.debug("Getting network for LB: %s", loadbalancer.id)
        return [self.network_driver.get_subnet(loadbalancer.vip.subnet_id).network_id]
